...
void abnormal_detect(struct ofproto *p)
{
    ...
    {  
      ...
      fp=fopen("home/lctuan/LOF/data_recording.log","a+");
      ...
      {  
        if(p->data_counter==0)
          fp=fopen("/home/lctuan/LOF/training.log","r");
        ...
        {
          p->writing=1;
          fp=fopen("/home/lctuan/LOF/training.log","a+");
        ...
        { 
          ...
          fp = fopen("/home/lctuan/LOF/lrd.log","a+");
          for (int i=0;i<p->data_counter;i++)
          {
             fprintf(fp,"%f\n",p->Data[i]->lrd);
          }
          ...
          fp=fopen("/home/lctuan/LOF/time.log","a+");
          fprintf(fp,"%lu\n",(end.tv_sec - start.tv_sec)*1000000+end.tv_usec-start.tv_usec);
          fclose(fp);
          fp=fopen("/home/lctuan/LOF/nor_training.log","a+");
          for(int i=0;i<p->data_counter;i++)
          {
     ...
     else 
      {
          ...
          //   p->lof_status=1;
          // else p->lof_status=0;
         // fp= fopen("/home/lctuan/LOF/time_detect.log","a+");
          ...
          fp= fopen("/home/lctuan/LOF/debug.log","a+");
